  ...
  return (
    <div>
      <h2 className="text-base font-semibold text-slate-900 dark:text-white mb-3 flex items-center">
        <Code2 className="mr-1.5 size-4 text-slate-500" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1">
            <Badge className="text-xs h-5 px-1.5 bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-300 border-0">
              Node.js
            </Badge>
            <Badge className="text-xs h-5 px-1.5 bg-green-50 text-green-700 dark:bg-green-900/20 dark:text-green-300 border-0">
              NestJS
