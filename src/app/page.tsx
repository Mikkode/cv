...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-background/90 relative">
      ...
      <DotPattern className="opacity-10" glow={true} /> */}

      <div className="container mx-auto py-8 px-4">
        {/* En-tête avec nom et titre */}
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-5xl font-bold mb-2">CARROT PIXEL</h1>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-2 border-purple-400 pl-4">
                      ...
                      <p className="text-sm">
                        Développement de logiciels pour l'automatisation et les
                    ...
                    <div className="border-l-2 border-purple-400 pl-4">
                      ...
                      <p className="text-sm">
                        Projets personnels avec Next.js et technologies modernes
                      </p>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent>
              <p className="text-sm">
                Passionné par l'innovation et le développement de solutions web
                modernes. Je m'adapte aux fuseaux horaires pour collaborer avec
            ...
            <CardContent>
              <ul className="text-sm space-y-2">
                <li className="flex items-center gap-2">
                  <ArrowRight className="size-3 text-purple-400" /> Applications
                  web performantes
                </li>
                <li className="flex items-center gap-2">
                ...
                <li className="flex items-center gap-2">
                  <ArrowRight className="size-3 text-purple-400" /> Optimisation
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent>
              <p className="text-sm mb-3">
                ...
                affinant mes compétences et explorant de nouvelles possibilités.
              </p>
